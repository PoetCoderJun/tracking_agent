...
from capabilities.tracking.types import TrackingObservation, TrackingState, TrackingTrigger
...
def normalize_tracking_state(raw_tracking_state: Any) -> TrackingState:
    ...
    try:
        next_tracking_turn_at = None if next_tracking_turn_at in (None, "") else float(next_tracking_turn_at)
    except (TypeError, ValueError):
    ...
    return TrackingState(
        ...
        next_tracking_turn_at=next_tracking_turn_at,
...
def tracking_state_snapshot(raw_tracking_state: Any) -> Dict[str, Any]:
    ...
    return {
        ...
        "next_tracking_turn_at": state.next_tracking_turn_at,
