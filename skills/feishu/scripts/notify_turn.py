...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    store = AgentSessionStore(state_root=state_root, frame_buffer_size=args.frame_buffer_size)
    message = str(args.message or _default_message(store, session_id)).strip()
